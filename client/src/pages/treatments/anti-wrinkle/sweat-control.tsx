            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="order-1 lg:order-2 w-full">
                <div className="relative w-full pb-[75%]">
                  <picture>
                    <source
                      srcSet="/hero_images/sweat-control-example.webp"
                      type="image/webp"
                    />
                    <img
                      src="/hero_images/sweat-control-example.webp"
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center px-6">
            <div className="flex flex-col items-center order-2 md:order-1">
              <div className="relative w-full pb-[75%]">
                <picture>
                  <source
                    srcSet="/hero_images/royalty-free-skin4.webp"
                    type="image/webp"
                  />
                  <img
                    src="/hero_images/royalty-free-skin4.webp"
                    alt="Sweat Control benefits example"
                    className="absolute inset-0 w-full h-full object-cover rounded-2xl shadow-lg"
                    loading="lazy"
                    width="1600"
                    height="1200"
              ...
              <p className="text-muted-foreground text-center text-sm mt-4">"This treatment has been life-changing! No more worrying about sweat marks."</p>
            </div>
            <div className="order-1 md:order-2">
              <h2 className="text-3xl lg:text-4xl font-serif font-bold mb-6 text-black text-center md:text-left">Why Choose Sweat Control at Aevia Skin?</h2>

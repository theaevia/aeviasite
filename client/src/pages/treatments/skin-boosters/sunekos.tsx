...
// Assets
import sunekosHero from "@assets/hero_images/royalty-free-skin1.webp";
        ...
        <section className="w-full bg-secondary py-12 md:py-16">
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center px-6">
            <div className="flex flex-col items-center order-2 md:order-1">
              <div className="relative w-full pb-[75%]">
                <picture>
                  ...
                  <img
                    ...
                    alt="Sunekos treatment benefits example"
                    className="absolute inset-0 w-full h-full object-cover rounded-2xl shadow-lg"
                    loading="lazy"
                    width="1600"
                    height="1200"
              ...
              <p className="text-muted-foreground text-center text-sm mt-4">"My skin looks so much brighter and healthier. The fine lines around my eyes have definitely softened."
</p>
            </div>
            <div className="order-1 md:order-2">
              <h2 className="text-3xl lg:text-4xl font-serif font-bold mb-6 text-black text-center md:text-left">Why Choose Sunekos® at Aevia Skin?</h2>

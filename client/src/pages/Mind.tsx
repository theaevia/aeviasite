          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <BookingButton href="/consultations?type=mind&package=discovery" variant="skin" className="w-full">
                  Book Now
                </BookingButton>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-primary">
                ...
                <BookingButton href="/consultations?type=mind&package=transform" variant="skin" className="w-full">
                  Book Now
                </BookingButton>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <BookingButton href="/consultations?type=mind&package=elite" variant="skin" className="w-full">
                  Book Now
                </BookingButton>
              </div>
            </div>

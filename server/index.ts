...
const VALID_ROUTES = [
  ...
  '/treatments/glycolic-peel',
  '/treatments/salicylic-peel',
  '/treatments/lactic-acid-peel',
  '/treatments/tca-peel',
  '/treatments/sculptra',
  '/treatments/clarity-strategy-session',
  '/treatments/discovery-call',
  '/treatments/momentum-6',
  '/treatments/transformation-12',
  '/treatments/elite-retainer',
  '/treatments/virtual-consultation',
  '/treatments/in-clinic-consultation',
  '/consultations',
  '/consultations/skin',
  '/consultations/mind',
  '/gallery',
